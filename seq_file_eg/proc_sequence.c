 ...
 */
static char navy[] = "The sequence iterator functions.We simply use the count of the next line as our internal position.";
...
static int ct_seq_show(struct seq_file *s, void *v)
{
	/*
	loff_t *spos = (loff_t *) v;
	seq_printf(s, "navy%Ld\n", *spos);
	return 0;
	*/
	seq_printf(s, "%c", navy[*((loff_t *)v)]);
	return 0;
}
